...
//Accordion
	$(".project_bild_list ul").prev().click(function() {
		$(this).parents(".project_bild_list").find("ul").not(this).slideUp().prev().removeClass("bild_active");
		$(this).next().not(":visible").slideDown().prev().addClass("bild_active");
	});
